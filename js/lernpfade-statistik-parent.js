/**
 * Überkapitel-Übersicht (z. B. body[data-parent-chapter-id="statistik"]).
 * Erwartet #statistik-subchapters und optional #statistik-curriculum-detail
 */
(function () {
  ...
  function init() {
    ...
    var subMount = document.getElementById('statistik-subchapters');
    ...
    var detail = document.getElementById('statistik-curriculum-detail');
    if (!detail) return;
